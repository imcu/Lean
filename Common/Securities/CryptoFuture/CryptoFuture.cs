...
namespace QuantConnect.Securities.CryptoFuture
{
    ...
    public class CryptoFuture : Security, IDerivativeSecurity, IContinuousSecurity
    {
        /// <summary>
        ...
        public CryptoFuture(SecurityExchangeHours exchangeHours,
            Cash quoteCurrency,
            ...
            )
        {
            ...
            BuyingPowerModel = new CryptoFutureMarginModel(0, this);
